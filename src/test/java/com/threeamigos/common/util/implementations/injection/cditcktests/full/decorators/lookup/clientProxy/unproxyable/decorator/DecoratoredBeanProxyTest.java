 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.decorators.lookup.clientProxy.unproxyable.decorator;
...
class DecoratoredBeanProxyTest {
    ...
    @Test
    void testClientProxyBeanWithAssociatedDecorator() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(),
                Fish.class,
                MarineDecorator.class,
                TestBean.class,
                Tuna.class);
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        addDecoratorBeansXml(syringe, MarineDecorator.class);
