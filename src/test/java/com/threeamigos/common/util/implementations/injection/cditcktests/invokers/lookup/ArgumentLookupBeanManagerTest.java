...
@Isolated
class ArgumentLookupBeanManagerTest {
    ...
    void test() throws Exception {
        ...
        try {
            ...
            assertEquals(Arrays.asList("foo", "bar", "foo", "bar"), MyService.observed);
    ...
    private static void resetState() {
        MyService.observed.clear();
        MyDependency.CREATED = 0;
        MyDependency.DESTROYED = 0;
    }
    ...
    public static class TestExtension extends InvokerHolderExtensionBase implements BuildCompatibleExtension {
        ...
        public void myServiceRegistration(BeanInfo bean, InvokerFactory invokers) {
            registerInvokers(bean, invokers, setOf("hello"), builder -> builder.withArgumentLookup(0));
        }
