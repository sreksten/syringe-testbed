 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.invokers.invalid.prodmethod;
...
@Isolated
class ProducerMethodBeanInvokerTest {
    ...
    void trigger() {
        ...
        syringe.addDiscoveredClass(MyProducer.class, BeanArchiveMode.EXPLICIT);
