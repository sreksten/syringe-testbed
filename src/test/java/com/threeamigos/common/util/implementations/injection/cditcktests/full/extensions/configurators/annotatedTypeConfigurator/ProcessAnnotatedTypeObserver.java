...
public class ProcessAnnotatedTypeObserver implements Extension {
    ...
    void observesDogPAT(@Observes ProcessAnnotatedType<Dog> event) {
        ...
        annotatedTypeConfigurator.add(RequestScoped.Literal.INSTANCE)
                .filterFields(af -> af.getJavaMember().getName().equals("feed"))
    ...
    void observesDogProducerPAT(@Observes ProcessAnnotatedType<DogProducer> event) {
        ...
        annotatedTypeConfigurator.methods().forEach(am -> am.remove(a -> a.annotationType().equals(Produces.class)));
        annotatedTypeConfigurator.fields().forEach(am -> am.remove(a -> a.annotationType().equals(Produces.class)));
    }
    ...
    void observesAnimalShelterPAT(@Observes ProcessAnnotatedType<AnimalShelter> event) {
        ...
        AnnotatedFieldConfigurator<? super AnimalShelter> fieldConfigurator = annotatedTypeConfigurator
                .filterFields(annotatedField -> annotatedField.getJavaMember().getName().equals("cat")).findFirst().get();
        ...
        annotatedTypeConfigurator.constructors().forEach(AnnotatedConstructorConfigurator::removeAll);
        annotatedTypeConfigurator.methods().forEach(AnnotatedMethodConfigurator::removeAll);
        annotatedTypeConfigurator.methods().forEach(annotatedMethodConfigurator ->
                annotatedMethodConfigurator.params().forEach(AnnotatedParameterConfigurator::removeAll));
        annotatedTypeConfigurator.fields().forEach(AnnotatedFieldConfigurator::removeAll);
    }
