package com.threeamigos.common.util.implementations.injection.cditcktests.full.extensions.observer.broken.exception;
...
class ProcessObserverMethodExceptionTest {
    ...
    @Test
    void testExceptionIsDefinitionError() {
        Syringe syringe = new Syringe(
                new InMemoryMessageHandler(),
                EventC.class,
                EventCObserver.class,
