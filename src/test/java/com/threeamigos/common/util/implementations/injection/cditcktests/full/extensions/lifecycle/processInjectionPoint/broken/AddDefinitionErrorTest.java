package com.threeamigos.common.util.implementations.injection.cditcktests.full.extensions.lifecycle.processInjectionPoint.broken;
...
class AddDefinitionErrorTest {
    ...
    void testDeployment() {
        ...
        syringe.addExtension(AddDefinitionErrorExtension.class.getName());
        syringe.initialize();
        syringe.addDiscoveredClass(Duke.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(World.class, BeanArchiveMode.EXPLICIT);
