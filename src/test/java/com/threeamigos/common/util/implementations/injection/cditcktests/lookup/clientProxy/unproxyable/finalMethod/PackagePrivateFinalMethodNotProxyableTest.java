...
@Isolated
class PackagePrivateFinalMethodNotProxyableTest {
    ...
    void testClassWithPublicFinalMethodCannotBeProxied() {
        ...
        syringe.initialize();
        syringe.addDiscoveredClass(PikeFarm.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(PikeBroken.class, BeanArchiveMode.EXPLICIT);
