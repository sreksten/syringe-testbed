 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.lookup.byname.ambiguous.broken;
...
class AmbiguousELNamesTest {
    ...
    void trigger() {
        ...
        syringe.initialize();
        syringe.addDiscoveredClass(FishProducer.class, BeanArchiveMode.EXPLICIT);
