package com.threeamigos.common.util.implementations.injection.cditcktests.full.extensions.producer.broken.injectionTargetError;
...
class InjectionTargetDefinitionErrorTest {
    ...
    @Test
    void testAddingDefinitionError() {
        ...
        syringe.addExtension(EventProcessor.class.getName());
