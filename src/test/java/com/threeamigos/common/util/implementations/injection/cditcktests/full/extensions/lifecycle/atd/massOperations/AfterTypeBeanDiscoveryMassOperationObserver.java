...
public class AfterTypeBeanDiscoveryMassOperationObserver implements Extension {
    ...
    private static volatile AfterTypeBeanDiscoveryMassOperationObserver instance;
    ...
    public AfterTypeBeanDiscoveryMassOperationObserver() {
        instance = this;
    }

    public static AfterTypeBeanDiscoveryMassOperationObserver getInstance() {
        return instance;
    }
