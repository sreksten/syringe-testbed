...
@Isolated
class NormalScopedBeanFinalClassInterceptorTest {
    ...
    void testFinalClassWithClassLevelInterceptor() {
        ...
        syringe.addDiscoveredClass(AntiAircraftMissileFinalClass.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(AntiAircraftIPBean.class, BeanArchiveMode.EXPLICIT);
        try {
