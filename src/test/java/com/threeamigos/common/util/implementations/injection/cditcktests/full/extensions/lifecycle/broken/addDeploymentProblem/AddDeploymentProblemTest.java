...
class AddDeploymentProblemTest {
    ...
    @Test
    void testObserverDeploymentProblemTreatedAsDeploymentError() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(), AddDeploymentProblemTest.class);
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        syringe.addExtension(AfterDeploymentValidationObserver.class.getName());
