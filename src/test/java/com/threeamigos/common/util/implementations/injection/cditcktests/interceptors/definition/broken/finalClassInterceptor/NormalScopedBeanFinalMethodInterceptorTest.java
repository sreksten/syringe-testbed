...
@Isolated
class NormalScopedBeanFinalMethodInterceptorTest {
    ...
    void testFinalMethodWithClassLevelInterceptor() {
        ...
        syringe.addDiscoveredClass(SurfaceToAirMissileFinalMethod.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(SurfaceToAirIPBean.class, BeanArchiveMode.EXPLICIT);
        try {
