...
@Isolated
class ExcessArgumentsInvokerTest {
    ...
    void test() throws Exception {
        ...
        try {
            ...
            assertEquals("foobar_a", hello.invoke(service, new Object[] { "a", "ignored" }));
            ...
            assertEquals(
                "quux_d",
                helloStatic.invoke(null, new Object[] { "d", Collections.<Object>emptyList(), Collections.<Object>emptySet() })
            );
        } finally {
            syringe.shutdown();
        }
