 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.build.compatible.extensions.priority.prioritytest.test;
...
public class PriorityExtension implements BuildCompatibleExtension {
    ...
    public void test(Messages msg) {
        ...
        List<String> actual = new ArrayList<String>(invocations);
