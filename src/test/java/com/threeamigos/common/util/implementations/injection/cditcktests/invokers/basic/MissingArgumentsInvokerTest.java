...
@Isolated
class MissingArgumentsInvokerTest {
    ...
    void test() {
        ...
        try {
            ...
            assertThrows(RuntimeException.class, () -> hello.invoke(service, null));
            assertThrows(RuntimeException.class, () -> hello.invoke(service, new Object[] {}));
            assertThrows(RuntimeException.class, () -> hello.invoke(new MyService(), new Object[] { 1 }));

            Invoker<MyService, String> helloStatic = invokers.get("helloStatic");
            assertThrows(RuntimeException.class, () -> helloStatic.invoke(null, null));
            assertThrows(RuntimeException.class, () -> helloStatic.invoke(null, new Object[] { "" }));
            assertThrows(RuntimeException.class, () -> hello.invoke(null, new Object[] {}));
        } finally {
            syringe.shutdown();
        }
    }
