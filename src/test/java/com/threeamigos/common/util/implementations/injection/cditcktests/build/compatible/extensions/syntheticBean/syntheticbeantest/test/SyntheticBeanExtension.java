 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.build.compatible.extensions.syntheticBean.syntheticbeantest.test;
    ...
    public void synthesize(SyntheticComponents syn, Types types) {
        ...
        syn.addBean(MyPojo.class)
                ...
                .withParam("data", AnnotationBuilder.of(MyComplexValue.class)
                        ...
                        .member("type",
                                types.ofClass("com.threeamigos.common.util.implementations.injection.cditcktests.build.compatible.extensions.syntheticBean.syntheticbeantest.test.MyEnum")
                                        .declaration())
                        .member("nested", AnnotationBuilder.of(
                                types.ofClass("com.threeamigos.common.util.implementations.injection.cditcktests.build.compatible.extensions.syntheticBean.syntheticbeantest.test.MySimpleValue")
                                        .declaration())
                                .value("no").build())
                        .build())
                .createWith(MyPojoCreator.class)
