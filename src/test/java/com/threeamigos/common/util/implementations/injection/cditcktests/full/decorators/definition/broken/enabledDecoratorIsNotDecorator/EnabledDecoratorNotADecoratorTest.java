 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.decorators.definition.broken.enabledDecoratorIsNotDecorator;
...
class EnabledDecoratorNotADecoratorTest {
    ...
    @Test
    void testEnabledDecoratorNotADecoratorTest() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(), Logger.class, MockLogger.class, TimestampLogger.class);
