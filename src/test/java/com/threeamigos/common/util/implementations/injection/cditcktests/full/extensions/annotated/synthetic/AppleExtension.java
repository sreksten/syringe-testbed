...
public class AppleExtension implements Extension {
    ...
    void registerApple(@Observes BeforeBeanDiscovery event, final BeanManager manager) {
        ...
        AnnotatedType<Apple> annotatedType = new AnnotatedTypeWrapper<Apple>(manager.createAnnotatedType(Apple.class), false) {
        };
        event.addAnnotatedType(annotatedType, AppleExtension.class.getName() + "." + Apple.class.getName());
    }
}
