 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.decorators.definition.broken.parameterizedTypesWithDifferentTypeParameters;
...
class DifferentTypeParametersTest {
    ...
    @Test
    void testTypeParametersOnDecoratedTypeAndDelegateTypeDoNotMatch() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(),
                Radio.class,
                RadioDecorator.class,
                RadioProducer.class);
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        addDecoratorBeansXml(syringe, RadioDecorator.class);
