package com.threeamigos.common.util.implementations.injection.cditcktests.full.lookup.injectionpoint.broken.reference.unresolved;
...
class UnsatisfiedInjectableReferenceTest {
    ...
    void testUnsatisfiedReference() {
        Syringe syringe = new Syringe(
                ...
                SimpleBean.class,
                InjectedBean.class,
                UnsatisfiedInjectionPoint.class,
