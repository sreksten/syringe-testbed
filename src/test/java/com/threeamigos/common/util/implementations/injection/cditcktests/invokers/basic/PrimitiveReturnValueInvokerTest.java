...
@Isolated
class PrimitiveReturnValueInvokerTest {
    ...
    void test() throws Exception {
        ...
        try {
            ...
            assertEquals(Integer.valueOf(42), hello.invoke(service, null));
            assertEquals(Integer.valueOf(42), hello.invoke(new MyService(), null));

            Invoker<MyService, Float> helloStatic = invokers.get("helloStatic");
            assertEquals(Float.valueOf(42.0F), helloStatic.invoke(null, null));
        } finally {
            syringe.shutdown();
        }
    }
