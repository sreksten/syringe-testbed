 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.lookup.dependency.resolution.broken.ambiguous;
...
class AmbiguousDependencyTest {
    ...
    void testAmbiguousDependency() {
        ...
        syringe.addDiscoveredClass(Farm_Broken.class, BeanArchiveMode.EXPLICIT);
