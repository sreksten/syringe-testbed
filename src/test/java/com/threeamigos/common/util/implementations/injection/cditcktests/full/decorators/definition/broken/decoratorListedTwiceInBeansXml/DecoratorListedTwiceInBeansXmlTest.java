 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.decorators.definition.broken.decoratorListedTwiceInBeansXml;
...
class DecoratorListedTwiceInBeansXmlTest {
    ...
    @Test
    void testDecoratorListedTwiceInBeansXmlNotOK() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(), Present.class, PresentDecorator.class);
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        addDecoratorBeansXml(syringe, PresentDecorator.class, PresentDecorator.class);
