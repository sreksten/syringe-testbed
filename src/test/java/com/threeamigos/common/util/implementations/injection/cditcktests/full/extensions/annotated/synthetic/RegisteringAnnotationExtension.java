...
public class RegisteringAnnotationExtension implements Extension {
    ...
    void registerMy(@Observes BeforeBeanDiscovery event, final BeanManager manager) {
        ...
        event.addAnnotatedType(
                manager.createAnnotatedType(TestAnnotation.class),
                RegisteringAnnotationExtension.class.getName() + "." + TestAnnotation.class.getName()
        );
    ...
    void registerJuicy(@Observes BeforeBeanDiscovery event, final BeanManager manager) {
        ...
        event.addAnnotatedType(
                manager.createAnnotatedType(Juicy.class),
                RegisteringAnnotationExtension.class.getName() + "." + Juicy.class.getName()
        );
