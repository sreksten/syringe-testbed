...
class BadInstanceInvokerTest {
    ...
    void test() {
        ...
        try {
            ...
            assertThrows(RuntimeException.class, () -> hello.invoke(new Object(), new Object[] { "" }));
            assertThrows(RuntimeException.class, () -> hello.invoke("", new Object[] { "" }));
            assertThrows(RuntimeException.class, () -> hello.invoke(Arrays.asList(""), new Object[] { "" }));
        } finally {
            syringe.shutdown();
        }
    }
