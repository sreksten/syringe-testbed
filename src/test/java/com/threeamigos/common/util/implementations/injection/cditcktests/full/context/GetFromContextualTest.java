...
class GetFromContextualTest {
    ...
    void testGetMayNotCreateNewInstanceUnlessCreationalContextGiven() {
        ...
        try {
            ...
            String sessionId = "full-context-get-from-contextual";
            ...
            try {
                ...
                CreationalContext<MySessionBean> myCreationalContext =
                        beanManager.createCreationalContext(mySessionBean);
                assertNotNull(sessionContext.get(mySessionBean, myCreationalContext));
            } finally {
