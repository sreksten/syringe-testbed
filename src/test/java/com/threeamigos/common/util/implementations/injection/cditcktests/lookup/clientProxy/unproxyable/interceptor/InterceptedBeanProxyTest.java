 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.lookup.clientProxy.unproxyable.interceptor;
...
class InterceptedBeanProxyTest {
    ...
    @Test
    void testClientProxyBeanWithBoundInterceptor() {
        Syringe syringe = new Syringe();
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        syringe.initialize();
        syringe.addDiscoveredClass(Fish.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(FishInterceptor.class, BeanArchiveMode.EXPLICIT);
