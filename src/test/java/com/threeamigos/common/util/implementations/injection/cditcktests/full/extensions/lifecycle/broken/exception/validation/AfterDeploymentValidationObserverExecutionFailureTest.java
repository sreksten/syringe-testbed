...
class AfterDeploymentValidationObserverExecutionFailureTest {
    ...
    void testObserverFailureTreatedAsDeploymentError() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(), AfterDeploymentValidationObserverExecutionFailureTest.class);
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        syringe.addExtension(ValidationObserver.class.getName());
