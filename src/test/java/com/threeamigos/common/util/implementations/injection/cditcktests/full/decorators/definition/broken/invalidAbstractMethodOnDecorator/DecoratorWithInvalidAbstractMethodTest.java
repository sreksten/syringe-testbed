 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.decorators.definition.broken.invalidAbstractMethodOnDecorator;
...
class DecoratorWithInvalidAbstractMethodTest {
    ...
    @Test
    void testAbstractMethodsNotDeclaredByDecoratedTypeNotOk() {
        Syringe syringe = new Syringe(new InMemoryMessageHandler(), Account.class, BankAccount.class, ThiefDecorator.class);
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        addDecoratorBeansXml(syringe, ThiefDecorator.class);
