 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.decorators.definition.broken.observer;
...
class DecoratorWithAsyncObserverMethodTest {

    @Test
    void testDecoratorWithAsyncObserverMethodNotOk() {
        ...
        addDecoratorBeansXml(syringe, ApplicationLogger.class);
