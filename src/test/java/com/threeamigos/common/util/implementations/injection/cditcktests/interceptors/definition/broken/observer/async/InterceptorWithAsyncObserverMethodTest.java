package com.threeamigos.common.util.implementations.injection.cditcktests.interceptors.definition.broken.observer.async;
...
@Isolated
class InterceptorWithAsyncObserverMethodTest {

    @Test
    void testInterceptorWithAsyncObserverMethodNotOk() {
