 ...
 */
package com.threeamigos.common.util.implementations.injection.cditcktests.full.extensions.afterBeanDiscovery.annotated.support.annotated;
...
public class AnnotatedMethodWrapper<X> extends AnnotatedCallableWraper<X> implements AnnotatedMethod<X> {
    ...
    public AnnotatedMethodWrapper(AnnotatedMethod<X> delegate, AnnotatedTypeWrapper<X> declaringType,
