...
class FinalMethodWithInheritedClassLevelInterceptorTest {
    ...
    @Test
    void testFinalMethodWithInheritedClassLevelInterceptor() {
        Syringe syringe = new Syringe();
        syringe.forceBeanArchiveMode(BeanArchiveMode.EXPLICIT);
        syringe.initialize();
        syringe.addDiscoveredClass(Jumbojet.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(Boeing.class, BeanArchiveMode.EXPLICIT);
