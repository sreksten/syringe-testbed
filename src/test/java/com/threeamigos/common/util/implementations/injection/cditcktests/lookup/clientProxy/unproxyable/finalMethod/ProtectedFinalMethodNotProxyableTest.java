...
@Isolated
class ProtectedFinalMethodNotProxyableTest {
    ...
    void testClassWithPublicFinalMethodCannotBeProxied() {
        ...
        syringe.initialize();
        syringe.addDiscoveredClass(CarpFarm.class, BeanArchiveMode.EXPLICIT);
        syringe.addDiscoveredClass(CarpBroken.class, BeanArchiveMode.EXPLICIT);
